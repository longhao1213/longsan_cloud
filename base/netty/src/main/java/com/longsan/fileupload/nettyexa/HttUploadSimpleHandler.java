package com.longsan.fileupload.nettyexa;
...
public class HttUploadSimpleHandler extends SimpleChannelInboundHandler<HttpObject> {

    public HttUploadSimpleHandler() {
        super(false);
    }
